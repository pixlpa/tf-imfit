...
time python tf-imfit/torch/torch-imfit5.py $SOURCEIMG \
    --iterations 1000 --single-iterations 20 --output-dir results/lores/ \
    --size 128 --num-gabors 256 --phase-split 0.5 --global-lr 0.02 \
    --local-lr 0.005 --mutation-strength 0.0005
