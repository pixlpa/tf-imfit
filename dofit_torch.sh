...
time python tf-imfit/torch/torch-imfit-nscale.py $SOURCEIMG --weight source_weights/$NAME-wt.png --iterations 2500 --output-dir results/final/ --size 256 --num-gabors 256 --rescales 2 --global-lr 0.009 --mutation-strength 0.005 --gamma 0.997 --l1 0.1 --gradient 0.1 --sobel 0.1
