...
time python tf-imfit/torch/torch-imfit5.py $SOURCEIMG --weight source_weights/$NAME-wt.png --iterations 3000 --output-dir results/hires/ --init results/lores/saved_model.pth --size 256 --init-size 128 --num-gabors 256 --global-lr 0.006 --mutation-strength 0.005 --gamma 1 --sobel 0.02
rm -f results/final/*.png
time python tf-imfit/torch/torch-imfit5.py $SOURCEIMG --weight source_weights/$NAME-wt.png --iterations 1500 --output-dir results/final/ --init results/hires/saved_model.pth --size 512 --init-size 256 --num-gabors 256 --global-lr 0.004 --local-lr 0.001 --mutation-strength 0.0 --gamma 1
