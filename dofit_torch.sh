...
time python tf-imfit/torch/torch-imfit-nscale.py $SOURCEIMG --weight source_weights/$NAME-wt.png --iterations 1000 --output-dir results/final/ --size 512 --num-gabors 512 --rescales 3 --global-lr 0.009 --mutation-strength 0.005 --gamma 0.997 --sobel 0.01
