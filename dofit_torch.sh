...
time python tf-imfit/torch/torch-imfit-nscale.py $SOURCEIMG --weight source_weights/$NAME-wt.png --iterations ITERATIONS --iter-multiple 2 --output-dir results/final/ --size 512 --num-gabors 512 --rescales 3 --global-lr 0.01 --mutation-strength 0.001 --gamma 0.995
