...
time python tf-imfit/torch/torch-imfit5.py source_images/img015.png --iterations 1500 --output-dir results/final/ --init results/hires/saved_model.pth --size 512 --init-size 256 --num-gabors 256 --global-lr 0.004 --local-lr 0.001 --mutation-strength 0.0 --gamma 0.99999
